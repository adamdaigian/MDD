    ...
    <div id="main" class="boxes">
        <div class="content">
            <div id="events">                
					...
					$recentPosts->query('post_type=wedding&posts_per_page=-1&orderby=date&order=asc'); ?>
        ...
        <div class="content">
			<div class="process-inner">
				...
				<div class="box last">
					...
					<img src="<?php bloginfo('template_directory'); ?>/images/ring-icon.png" />
				</div>
